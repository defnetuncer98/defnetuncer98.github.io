...
Below the fold: about, the experience timeline, shipped titles (Color Bus Trip,
Knit N Loop, Mayor Match…), and personal projects under
[Blue Variable](https://bluevariable.github.io/) — A Cube Story (in development)
with its trailer and in-engine captures, Purrfect Fit, and an open-source lab.
